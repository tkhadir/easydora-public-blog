...
For example:
- You fixed 8 toys this week
- 2 of those fixes made other problems
- Your Change Failure Rate = 2 ÷ 8 × 100 = **25%**
...
- [DevOps Research and Assessment (DORA) Metrics Official Guide](https://dora.dev/)
- [Google's DORA Metrics Documentation](https://cloud.google.com/blog/products/devops-continuous-delivery/dora-research-program)
- [Understanding DORA:  A Beginner's Guide](https://www.atlassian.com/continuous-delivery/learning-paths/devops/dora-metrics)

### For Learning More About Software Development:
- [What is DevOps? - Explained Simply](https://www.atlassian.com/devops)
- [Introduction to Continuous Integration & Continuous Deployment](https://www.circleci.com/continuous-integration/)
...
- [Code.org - Teach Every Student to Code](https://code.org/)
...
- [DashBoard - GitHub Actions Integration](https://github.com/features/actions)
- [LaunchDarkly - Feature Management](https://launchdarkly.com/)
- [PagerDuty - Incident Response](https://www.pagerduty.com/)
- [Atlassian Jira - Project Management](https://www.atlassian.com/software/jira)
